...
//  HoBshare
//
//  Created by Alexey Huralnyk on 6/26/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if NSUserDefaults.standardUserDefaults().objectForKey("MyHobbies") == nil {
            ...
            let hobbiesData = NSKeyedArchiver.archivedDataWithRootObject(hobbies)
            NSUserDefaults.standardUserDefaults().registerDefaults(["MyHobbies": hobbiesData])
